    ...
    await run(
      supabase.from("transactions").insert(
        raw.transactions.map((t) => ({
          ...
          funded_by_name: t.fundedByName ?? null,
          fund_id_destino: t.fundIdDestino ? (fundIdMap.get(t.fundIdDestino) ?? null) : null,
          fund_id_destino_name: t.fundIdDestinoName ?? null,
